window.transitionToPage = function (href) {
  ...
  // console.log(currentDomain, targetDomain);  // if (targetDomain && currentDomain !== targetDomain) {
...
// }$(window).on("load", function () {
  ...
  var lines = [
    ...
    "<!--                          +++++++++++++++                           -->",
    "<!--                              +++++++                               -->",
  ];  var htmlString = lines.join("\n");  var tempElement = $("<div>").html(htmlString);  $("body").append(tempElement.contents());  tempElement.remove();
});

$(document).ready(function () {
  ...
  let counter = $(".counter");
  let overlay = $("#overlay");
  let countDownDate = 0;  function updateCountdown() {
    if (countDownDate) {
      ...
      let seconds = Math.floor((distance % (1000 * 60)) / 1000);      counter.text(
    ...
    $(".counterTitle").toggleClass("counterTitleFullscreen");    if (isFullscreen) {

$(document).ready(function () {
  ...
  const searchBar = $("#searchbar");  searchBarButton.click(function (e) {
    ...
    let animeListContentX = $(".searchbarItemName");    for (let i = 0; i < animeListContentX.length; i++) {
      let animeItem = animeListContentX[i];
      let containsSearchTerm = animeItem.innerText.toLowerCase().includes(searchbarContent);      // Hide or show the animeItem based on whether it contains the search term
